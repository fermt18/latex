...
%--------------------------------------
\section{Reviewing}
In order to get feedback from the supervisor and ease project progress reviewing, both the application development and this document are regularly updated in the author's GitHub public repositories.
\begin{itemize}
