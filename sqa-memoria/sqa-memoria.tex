...
\degree{Software Quality Assurance postgraduate} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
This project covers the test specification and automated test execution of a micro service based application that simulates an e-commerce shop. Even though software development is not part of the focus of this course, in order to have a proper target for the set of tests defined, a small application based on the Spring framework is developed. The functionality of this application is specified with the own test specifications written in Gherkin language and trying to simulate a Business Driven Development approach.
For test execution, the Java implementation of the Cucumber framework has been used. At the same time, automation is achieved through a Jenkins pipeline putting more emphasis in environment administration with Docker.\ldots
\end{abstract}
...
% TODO: new chapter: Objetivos del trabajo;
\include{Chapters/Chapter1} %Application
\include{Chapters/Chapter2} %Test Specification 
\include{Chapters/Chapter3} %Test Execution Automation
% TODO: new chapter: Descripción del trabajo realizado (estructura propia); Planificación final
\include{Chapters/Chapter4} %Conclusions; TODO: Problemas resueltos y dificultades;
