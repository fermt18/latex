...
\paragraph At the same time, two more topics out of the course scope are included in the solution:
...
\paragraph So the objectives, in order of importance, are the following:
\begin{itemize}
...
%--------------------------------------
\section{Reviewing}
\paragraph Both the application source code and this document can be found in the author's GitHub public repositories:
\begin{itemize}
\item Application Development: \hyperref[]{\textcolor[rgb]{0,0,1}{https://github.com/fermt18/sqa-project}}
\item Project Report: \hyperref[]{\textcolor[rgb]{0,0,1}{https://github.com/fermt18/latex/tree/master/sqa-memoria}}
\end{itemize}